...
The e2e suite (``evals.run_llm_eval --suite e2e``) drives real
...
(``evals.seed``) or production memories.
...
Examples:
    ...
    python -m evals.e2e_seed --dry-run

    # Seed the e2e corpus (memories + chunks)
    python -m evals.e2e_seed
...
from evals.llm_ground_truth import E2EItem, load_e2e_items
