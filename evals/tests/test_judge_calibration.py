"""Unit tests for evals/judge_calibration.py — metrics + runner.
...
import evals.experiments.judge_calibration as cal_mod
from evals.experiments.judge_calibration import (
    aggregate,
    compare_sample,
    coverage_prf,
    run_calibration,
