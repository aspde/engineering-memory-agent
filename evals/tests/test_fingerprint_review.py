"""Tests for the fingerprint review helper (evals/experiments/fingerprint_review.py).
...
from evals.dataset import SeedMemory
from evals.experiments.fingerprint_review import (
    _phrase_candidates,
    _tokens,
    build_review_rows,
...
class TestEndToEnd:
    def test_review_then_apply_over_temp_files(self, tmp_path) -> None:
        from evals.experiments.fingerprint_review import _read_jsonl, _write_jsonl
