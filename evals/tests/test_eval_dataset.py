"""Unit tests for evals/dataset.py — loading, validation, matching.
...
class TestGroundTruthStructure:
    ...
    def test_difficulty_distribution(self) -> None:
        from evals.ground_truth import difficulty_distribution
...
class TestSemanticMatching:
    ...
    async def test_semantic_hit_and_miss(self, monkeypatch) -> None:
        ...
        from evals.dataset import semantic_relevance_mask
