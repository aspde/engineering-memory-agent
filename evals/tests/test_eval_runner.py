"""Unit tests for evals/runner.py — orchestration and aggregation.
...
from evals.dataset import RetrieverAdapter
from evals.ground_truth import CATEGORIES, DIFFICULTIES, GroundTruthItem
...
class TestCompareEval:
    ...
    async def test_preserves_order(
        ...
        monkeypatch.setattr("evals.runner.build_adapter", fake_build)
    ...
    async def test_reraise_propagates(
        ...
        monkeypatch.setattr(
            "evals.runner.build_adapter", lambda *a, **kw: adapter
        )
