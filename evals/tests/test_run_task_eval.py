"""Unit tests for evals/run_task_eval.py — CLI orchestration.
...
from evals.run_task_eval import _build_parser, _run
from evals.task_runner import TaskEvalResult
...
def patch_runner(monkeypatch):
    ...
    import evals.run_task_eval as run_mod
    ...
    monkeypatch.setattr("evals.task_runner.run_tasks", _fake)
    return state
