...
Usage:
    python -m evals.experiments.threshold_calibration --report-md evals/reports/archive/threshold_calibration_report.md
"""
...
from evals.dataset import load_seed_memories
...
async def _main(report_md: str | None) -> int:
    ...
    if report_md:
        lines = [
            ...
            "## 方法",
            "",
            "三类摘要对（`evals/experiments/threshold_calibration.py`）：",
            "",
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m evals.experiments.threshold_calibration",
