...
[需要你补充：以下数据需替换为真实值，没有的项目删掉]

| 指标 | 数值 |
|------|------|
| 数据源接入数 | 4 个（Git / PingCode / CI / 飞书） |
| 记忆库规模 | [需要你补充：如 3000+ 条] |
| 日均检索次数 | [需要你补充：如 50+ 次] |
| Agent 单轮平均 tool 调用 | [需要你补充：如 2.3 个] |
| 对话 P95 延迟 | [需要你补充：如 4.2 秒] |
| 向量召回延迟 | [需要你补充：如 12ms（top_k=5）] |
| 代码量 | 后端 [需要你补充：如 8000] 行 + 前端 [需要你补充：如 5000] 行 |
| 测试覆盖 | [需要你补充：如 80+ 测试用例] |
